...
class SendNotificationApiDelegateImplTest {
    ...
    void testSendUserMessage() throws Exception {
        ...
        UserMessageRequestModel messageRequest =
                new UserMessageRequestModel(UUID.randomUUID(), templateKey, messageParameters);
    ...
    @Test
    void testSendUserMessage_template_not_found() throws Exception {
        String templateKey = RandomStringUtils.randomAlphanumeric(10);
        createMessageTemplate(templateKey);
        Map<String, String> messageParameters =
                Map.of(
    ...
    @Test
    void testSendUserMessage_parameter_not_found() throws Exception {
        String templateKey = RandomStringUtils.randomAlphanumeric(10);
        createMessageTemplate(templateKey);
        Map<String, String> messageParameters =
                Map.of(
    ...
    @Test
    void testSendUserMessage_incorrect_parameter_type() throws Exception {
        String templateKey = RandomStringUtils.randomAlphanumeric(10);
        createMessageTemplate(templateKey);
        Map<String, String> messageParameters =
                Map.of(
    ...
    void testSendDirectMessage() throws Exception {
        ...
        DirectMessageRequestModel messageRequest = new DirectMessageRequestModel();
        messageRequest.setCommunicationMethod("email");
        messageRequest.setDestination("test@example.com");
        messageRequest.setTemplateKey(templateKey);
        messageRequest.setParameters(
                Map.of(
                        "parameter1", "2023-01-01",
                        "parameter2", "Mr Bean",
                        "parameter3", "45",
    ...
    @Test
    void testSendDirectMessage_template_not_found() throws Exception {
        ...
        messageRequest.setCommunicationMethod("email");
        messageRequest.setDestination("test@example.com");
        messageRequest.setTemplateKey("nonexistent template");
        messageRequest.setParameters(
                Map.of(
                        "parameter1", "2023-01-01",
                        "parameter2", "Mr Bean",
    ...
    @Test
    void testSendDirectMessage_parameter_not_found() throws Exception {
    ...
    @Test
    void testSendDirectMessage_incorrect_parameter_type() throws Exception {
    ...
    @Test
    void testGetUserMessage() throws Exception {
        String templateKey = RandomStringUtils.randomAlphanumeric(10);
        createMessageTemplate(templateKey);
        Map<String, String> messageParameters =
                Map.of(
        ...
        UserMessageResponseModel messageResponse =
                objectMapper.readValue(contentResponse, UserMessageResponseModel.class);
